const wishes = [
  ...
  {
    name: "Алина Рихтер",
    text: "Желаю неиссякаемого потока идей и проектов которые будут радовать. Что бы твой талант ценился по достоинству, а так же энергии для новых свершений, верных друзей и безграничного личного счастья :partying_face: ",
  },
  {
    name: "Яна Черкай",
