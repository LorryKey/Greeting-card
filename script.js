const wishes = [
  ...
  {
    name: "Валя Маликова",
    text: "С днем рождения, Рома! Желаю счастья, здоровья, удачи, ярких эмоций и самых интересных задач 🥳  🎉  💫 ",
  },
  {
    name: "Кристина Батухтина",
    text: "С днём рождения, Рома! ♥ Конечно же всего самого наилучшего, здоровья побольше, денег и исполнения твоих заветных мечт. Ценю тебя за твою энергичность, отзывчивость и лёгкость! Пусть твои идеи реализуются, приносят результат, и кайфовой работы в команде)))",
  },
];
